            ...
            <div id="content">
                ...
                <div class="container-fluid" style="min-height: 450px;">
                    ...
                    <div class="container-fluid py-3">
                        <h1 class="p-1 text-dark" style="font-weight: bold;">Riwayat Pemesanan Anda</h1>
                        <?php
                                        ...
                                        <div class="col-sm-12 col-md-4">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                ?>
                                                    ...
                                                    <a href="" class="btn btn-sm btn-danger"><i class="fas fa-times-circle mr-1"></i> Batalkan pesanan</a>
                                                <?php
                                                } elseif (($today >= $data['tgl_cekin']) and ($today < $data['tgl_cekout'])) {
                                                ?>
                                                    <a target="_blank" href="./cetak.php?id=<?= $data['id_pemesanan'] ?>" class="btn btn-sm btn-warning mr-2"><i class="fas fa-print mr-1"></i> Cetak pesanan</a>
                                                    <a target="" href="./cetak2.php" class="btn btn-sm btn-info mr-2"><i class="fas fa-print mr-1"></i> Testing</a>
                                                <?php
                                                } elseif ($today >= $data['tgl_cekout']) {
                                                ?>
