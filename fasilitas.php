            ...
            <div id="content">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="./fasilitas.php" id="userDropdown" aria-haspopup="true" aria-expanded="false">
                                    <span class="mr-2 d-sm-none d-lg-inline text-gray-600 active"><i class="fas fa-building"></i> Fasilitas</span>
                                </a>
                            </li>
                ...
                <div class="container-fluid" style="min-height: 450px;">
                    ...
                    <div class="container-fluid py-3">
                        <h1 class="p-1 text-dark" style="font-weight: bold;">Fasilitas Hotel</h1>
                        <div class="row">
                                ...
                                <div class="col-md-4 mb-4">
                                    <a href="" class="text-decoration-none">
                                        <div class="card shadow">
                                            ...
                                            <span class="text-center p-2 text-dark"><?= $data['nama_fasilitas'] ?></span>
                                        </div>
                                    </a>
                                </div>
                            <?php
