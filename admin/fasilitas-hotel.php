                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="./fasilitas-hotel.php" id="userDropdown" aria-haspopup="true" aria-expanded="false">
                                    <span class="mr-2 d-sm-none d-lg-inline text-gray-600 active"><i class="fas fa-building"></i> Fasilitas Hotel</span>
                                </a>
                            </li>
                ...
                <div class="container-fluid" style="min-height: 450px;">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a href="./create.php?cek=fasilitas hotel" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah</a>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody class="">
                                        ...
                                        ?>
                                            <tr class="col">
                                                ...
                                                <td class="col-3"><?= $data['keterangan'] ?></td>
                                                <td class="col-2"><img src="./gambar/<?= $data['image'] ?>" alt="Gambar Fasilitas Hotel" width="200px" height="100px"></td>
                                                <td class="col-2">
                                                    <a href="./edit.php?cek=fasilitas hotel&id=<?= $data['id'] ?>" class="btn btn-warning"><i class="fas fa-edit"></i> Edit</a>
                                                    <a href="./delete.php?cek=fasilitas_hotel&id=<?= $data['id'] ?>" class="btn btn-danger"><i class="fas fa-trash"></i> Delete</a>
                                                </td>
                                            </tr>
                                        <?php
                                        }
