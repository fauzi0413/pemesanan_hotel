                ...
                <div class="container-fluid" style="min-height: 450px;">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a href="./create.php?cek=kamar" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah</a>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody class="">
                                        ...
                                        ?>
                                            <tr class="col">
                                                ...
                                                <td class="col-2"><?= $data['jumlah_kamar'] ?></td>
                                                <td><img src="./gambar/<?= $data['banner'] ?>" alt="banner" width="200px" height="100px"></td>
                                                <td class="col-2">
                                                    <a href="./edit.php?cek=kamar&id=<?= $data['id'] ?>" class="btn btn-warning"><i class="fas fa-edit"></i> Edit</a>
                                                    <a href="./delete.php?cek=kamar&id=<?= $data['id'] ?>" class="btn btn-danger"><i class="fas fa-trash"></i> Delete</a>
                                                </td>
                                            </tr>
                                        <?php
                                        }
